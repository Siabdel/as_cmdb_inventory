# Generated by Django 5.0.1 on 2026-03-30 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('printer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='printer.printer')),
                ('template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='printer.printtemplate')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='printer.printtemplate'),
        ),
        migrations.CreateModel(
            name='PrintLog',
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='printer.printjob')),
                ('printed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-printed_at'],
                'indexes': [models.Index(fields=['asset', '-printed_at'], name='printer_pri_asset_i_173d42_idx'), models.Index(fields=['printed_by', '-printed_at'], name='printer_pri_printed_04e948_idx')],
            },
        ),
    ]
